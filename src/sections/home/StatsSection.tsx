          ...
          {COMPANY_STATS.map((stat, i) => (
            <StaggerItem key={stat.label} direction="up">
              <div className="relative">
                ...
                {i > 0 && (
                  <div className="pointer-events-none absolute -left-4 top-1/2 hidden h-12 w-px -translate-y-1/2 bg-gradient-to-b from-transparent via-gold-500/25 to-transparent lg:block" />
                )}
                <StatCounter
                  value={stat.value}
                  suffix={stat.suffix}
